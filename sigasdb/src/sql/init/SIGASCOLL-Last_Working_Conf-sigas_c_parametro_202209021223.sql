...
<<DENOMINAZIONE_SOC>> - <<CODICE_SOCIETA>>',NULL,NULL,NULL,'2020-11-17',NULL),
	 ...
	 (44,'mittenteMailConfermaAccreditamento','assistenza.sigas@csi.it',NULL,NULL,NULL,'2020-11-23',NULL),
...
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 ...
	 (57,'pagamentoPpayMittenteMailConferma','assistenza.sigas@csi.it',NULL,NULL,NULL,'2019-01-29',NULL),
	 ...
	 (3,'codiceAmbiente','COLL',NULL,NULL,NULL,'2020-04-20',NULL),
	 ...
	 (68,'epay_service_callback','https://dev-portale.ruparpiemonte.it/sigas/home/ppayCallback',NULL,NULL,NULL,'2021-01-28',NULL),
...
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 ...
	 (66,'epay_service_codice_versamento','QZ00',NULL,NULL,NULL,'2021-01-28',NULL),
	 ...
	 (69,'epay_service_endpoint_redirect_callid','engsigasppaytest',NULL,NULL,NULL,'2021-01-28',NULL),
	 (70,'epay_service_endpoint_redirect_call_pass','ppayTSqkdQb5sYEf',NULL,NULL,NULL,'2021-01-28',NULL),
	 (73,'ACTA_PORT',NULL,80,NULL,NULL,'2021-01-28',NULL);
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 (74,'ACTA_IS_WS',NULL,NULL,NULL,true,'2021-01-28',NULL),
	 (76,'ACTA_SERVER_PROTOCOL','http://',NULL,NULL,NULL,'2021-01-28',NULL),
	 ...
	 (81,'ACTA_CODE_FRUITORE','SIGAS',NULL,NULL,NULL,'2021-01-28',NULL),
	 (82,'codiceClassificazione','4.70.10',NULL,NULL,NULL,'2021-01-28',NULL),
	 (80,'ACTA_ID_NODO','23',NULL,NULL,NULL,'2021-01-28',NULL),
	 (79,'ACTA_ID_STRUTTURA','13',NULL,NULL,NULL,'2021-01-28',NULL),
	 (77,'ACTA_ID_AOO','6',NULL,NULL,NULL,'2021-01-28',NULL),
	 (78,'ACTA_CF','SGSFTR80A01L219U',NULL,NULL,NULL,'2021-01-28',NULL);
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 (83,'cognomeDirigente','ZANELLA',NULL,NULL,NULL,'2021-01-28',NULL),
	 (84,'nomeDirigente','FABRIZIO',NULL,NULL,NULL,'2021-01-28',NULL),
	 (85,'mailSettoreTributi','settore.tributi@regione.piemonte.it',NULL,NULL,NULL,'2021-01-28',NULL),
	 (87,'APPLICATION_KEY_ACTA','24/65/61/-67/-101/-61/-28/36/11/121/-3/-116/-108/-39/-112/-73',NULL,NULL,NULL,'2021-01-28',NULL),
	 (88,'ACTA_SIGN_STEP_BYPASS_FLAG','0001000',NULL,NULL,NULL,'2021-01-28',NULL),
	 (89,'DICHIARAZIONI_SERIE_FASCICOLI_CODICE','ARISGANWEBDICH',NULL,NULL,NULL,'2021-01-28',NULL),
	 (90,'RIMBORSI_SERIE_FASCICOLI_CODICE','ARISGANWEBRIMB',NULL,NULL,NULL,'2021-01-28',NULL),
	 (91,'COMUNICAZIONI_VARIE_SERIE_FASCICOLI_CODICE','ARISGANWEBCOMV',NULL,NULL,NULL,'2021-01-28',NULL),
	 (92,'DEPOSITI_CAUZIONALI_SERIE_FASCICOLI_CODICE','ARISGANWEBDEPCA',NULL,NULL,NULL,'2021-01-28',NULL),
	 (93,'ACCERTAMENTI_VARIE_SERIE_FASCICOLI_CODICE','ARISGANWEBACC',NULL,NULL,NULL,'2021-01-28',NULL);
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 (94,'ACTA_TARGETOBJECT','ClassificazioniProtocollateView',NULL,NULL,NULL,'2021-01-28',NULL),
	 (95,'ACTA_NAMESPACEURI','objectservice.acaris.acta.doqui.it',NULL,NULL,NULL,'2021-01-28',NULL),
	 (96,'ACTA_LOCALPART','ObjectService',NULL,NULL,NULL,'2021-01-28',NULL),
	 (97,'ACTA_ENDPOINTADDRESS','objectWS?wsdl',NULL,NULL,NULL,'2021-01-28',NULL),
	 (98,'ACTA_NAVIWSDLLOCATION','navigationWS?wsdl',NULL,NULL,NULL,'2021-01-28',NULL),
	 (99,'ACTA_RELAWSDLLOCATION','relationshipsWS?wsdl',NULL,NULL,NULL,'2021-01-28',NULL),
	 (100,'ACTA_CODICE','codice',NULL,NULL,NULL,'2021-01-28',NULL),
	 (101,'ACTA_ANNO','anno',NULL,NULL,NULL,'2021-01-28',NULL),
	 (102,'ACTA_IDAOOPROTOCOLLANTE','idAooProtocollante',NULL,NULL,NULL,'2021-01-28',NULL),
	 (103,'INDEX_BASEURL','http://tst-applogic.reteunitaria.piemonte.it/ecmenginews-exp02/',NULL,NULL,NULL,'2021-01-28',NULL);
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 (104,'INDEX_URLWS1','/services/EcmEngineManagement',NULL,NULL,NULL,'2021-01-28',NULL),
	 (105,'INDEX_FRUITORE','sigas',NULL,NULL,NULL,'2021-01-28',NULL),
	 (106,'INDEX_REPOSITORY','primary',NULL,NULL,NULL,'2021-01-28',NULL),
	 (107,'INDEX_USERNAME','admin@sigas',NULL,NULL,NULL,'2021-01-28',NULL),
	 (108,'INDEX_PASSWORD','sigas',NULL,NULL,NULL,'2021-01-28',NULL),
	 (109,'INDEX_UIDPADRE','ea4219d6-d8db-11eb-81d5-6790efe1e9c9',NULL,NULL,NULL,'2021-01-28',NULL),
	 (110,'INDEX_TYPEPREFIXEDNAME','sigas:documento',NULL,NULL,NULL,'2021-01-28',NULL),
	 (111,'INDEX_MODELPREFIXEDNAME','sigas:model',NULL,NULL,NULL,'2021-01-28',NULL),
	 (112,'INDEX_PARENTASSOCTYPEPREFIXEDNAME','cm:contains',NULL,NULL,NULL,'2021-01-28',NULL),
	 (113,'INDEX_CONTENTPROPERTYPREFIXEDNAME','cm:content',NULL,NULL,NULL,'2021-01-28',NULL);
INSERT INTO sigas_c_parametro (id_parametro,desc_parametro,valore_string,valore_number,valore_date,valore_boolean,inizio_validita,fine_validita) VALUES
	 (71,'ACTA_SERVER','coll-intranet.regione.piemonte.it',NULL,NULL,NULL,'2021-01-28',NULL),
	 (86,'REPOSITORY_ACTA','RPGIUNTATEST Ente Test Regione Piemonte',NULL,NULL,NULL,'2021-01-28',NULL);

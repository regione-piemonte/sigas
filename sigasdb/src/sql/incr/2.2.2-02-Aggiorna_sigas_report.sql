...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="Template-03-lettera-accompagnamento" pageWidth="595" pageHeight="842" columnWidth="555" leftMargin="20" rightMargin="20" topMargin="40" bottomMargin="20" uuid="3a198f7c-26e6-4466-8e16-f6ebefcfa2ac">
	...
	<subDataset name="dichiarazioneVersamentiSD" uuid="406f4309-c7de-44d9-909d-cb652cbb978e">
		...
		<field name="importo_calcolato" class="java.lang.Double"/>
		<field name="differenza" class="java.lang.Double"/>		
		<field name="note" class="java.lang.String"/>		
	</subDataset>
	<parameter name="dichiarazioneVersamenti" class="net.sf.jasperreports.engine.data.JRBeanCollectionDataSource"/>
	<parameter name="anno" class="java.lang.String"/>
	<parameter name="mese" class="java.lang.String"/>
	<parameter name="denominazioneAnag" class="java.lang.String"/>	
	<queryString>
		...
		<band height="280">
			...
			<textField>
				<reportElement x="0" y="250" width="980" height="30" isRemoveLineWhenBlank="true" uuid="5a055f2e-38bc-4047-834e-c3a776614665">
					<printWhenExpression><![CDATA[$P{denominazioneAnag} != null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Soggetto dichiarante:  " + $P{denominazioneAnag}]]></textFieldExpression>
			</textField>			
		</band>
	</title>
	<detail>
		...
		<band height="76">			
			...
			<componentElement>
				...
				<jr:table xmlns:jr="http://jasperreports.sourceforge.net/jasperreports/components" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports/components http://jasperreports.sourceforge.net/xsd/components.xsd" whenNoDataType="AllSectionsNoDetail">
					<datasetRun subDataset="dichiarazioneVersamentiSD" uuid="2bf38382-8ac0-4f92-975a-7f5e90ec1e48">
						<dataSourceExpression><![CDATA[$P{dichiarazioneVersamenti}]]></dataSourceExpression>
					</datasetRun>					
...
where id_report in (select id_report 
					from sigas_report 
					where cod_report like 'EXCEL_DICHIARAZIONE_VERSAMENTI')
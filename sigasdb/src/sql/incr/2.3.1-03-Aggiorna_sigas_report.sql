----------------------------------------
--UTLIZZARE OPZIONE IGNORA PARAMETERS
----------------------------------------
update sigas_report 
set jasper = null,
jrxml = CAST('<!-- Created with Jaspersoft Studio version 6.15.0.final utlizzo versione della libreria JasperReports6.15.0-dd49bfb94918336b8321d5507193f0169ead4e95  -->
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="Template-dettaglio-soggetto" pageWidth="595" pageHeight="842" columnWidth="555" leftMargin="20" rightMargin="20" topMargin="40" bottomMargin="20" uuid="3a198f7c-26e6-4466-8e16-f6ebefcfa2ac">
	...
	<subDataset name="dettaglioSoggettoSD" uuid="406f4309-c7de-44d9-909d-cb652cbb978e">
		<queryString language="SQL">
			<![CDATA[]]>
		</queryString>
		<field name="provinciaErogazione" class="java.lang.String"/>
		<field name="totaleVersato" class="java.lang.Double"/>
		<field name="totaleDichiarazione" class="java.lang.Double"/>
		<field name="addizionaleLiquidata" class="java.lang.Double"/>				
	</subDataset>
	<parameter name="dettaglioSoggetto" class="net.sf.jasperreports.engine.data.JRBeanCollectionDataSource"/>
	<parameter name="denominazione" class="java.lang.String"/>
	<parameter name="codiceAzienda" class="java.lang.String"/>
	...
	<parameter name="fideussione" class="java.lang.String"/>
	<parameter name="importoFideussione" class="java.lang.Double"/>
		...
		<band height="280">
			...
			<textField>
				<reportElement x="0" y="250" width="980" height="30" isRemoveLineWhenBlank="true" uuid="5a055f2e-38bc-4047-834e-c3a776614665">
					<printWhenExpression><![CDATA[$P{denominazione} != null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Denominazione:  " + $P{denominazione}]]></textFieldExpression>
			</textField>			
		</band>
	</title>
	<detail>
		<band height="181">
			...
			<textField>
				<reportElement x="0" y="1" width="340" height="30" isRemoveLineWhenBlank="true" uuid="120c2b25-5a21-4170-ad94-2739f07e1dbb">
					<printWhenExpression><![CDATA[$P{codiceAzienda} != null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Codice Azienda: " +$P{codiceAzienda}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="358" y="1" width="622" height="30" isRemoveLineWhenBlank="true" uuid="f2107440-952c-4f8c-9906-45048d569edf">
					<printWhenExpression><![CDATA[$P{indirizzo} != null]]></printWhenExpression>					
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Indirizzo:  " + $P{indirizzo}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="0" y="31" width="340" height="30" isRemoveLineWhenBlank="true" uuid="1b954333-b28f-461d-8002-e91568bb4fee">
					<printWhenExpression><![CDATA[$P{comune}!= null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Comune:  " + $P{comune}]]></textFieldExpression>
			</textField>			
			<textField>
				<reportElement x="358" y="31" width="622" height="30" uuid="82559a4e-db38-426d-b17e-007b35a7fef9">					
					<printWhenExpression><![CDATA[$P{provincia}!= null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Provincia:  " + $P{provincia}]]></textFieldExpression>
			</textField>			
			<textField>
				<reportElement x="1" y="61" width="339" height="30" isRemoveLineWhenBlank="true" uuid="c3b0281a-25c0-48ff-9e38-a4b7586cdbb7">
					<printWhenExpression><![CDATA[$P{iban}!= null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Iban: " +$P{iban}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="358" y="61" width="622" height="30" isRemoveLineWhenBlank="true" uuid="4cf908fc-8cee-45ba-8ce0-5a5f967769ca">
					<printWhenExpression><![CDATA[$P{telefono} != null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
			...
			<textField>
				<reportElement x="0" y="91" width="340" height="30" isRemoveLineWhenBlank="true" uuid="64ab97f8-9fd0-4906-a201-fb313fed238e">
					<printWhenExpression><![CDATA[$P{pec}!= null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Pec:  " + $P{pec}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="358" y="91" width="622" height="30" isRemoveLineWhenBlank="true" uuid="82050338-03ae-4e12-8174-458a40cb4c56">
					<printWhenExpression><![CDATA[$P{email} != null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
			...
			<textField>
				<reportElement x="0" y="121" width="580" height="30" isRemoveLineWhenBlank="true" uuid="f2da75e0-d8d4-4ae0-b663-6b2bac6996a5">
					<printWhenExpression><![CDATA[$P{fideussione}!= null]]></printWhenExpression>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
					<font fontName="SansSerif" size="14" isBold="true"/>
				</textElement>
				<textFieldExpression><![CDATA["Copertura Fidejussoria:  " + $P{fideussione}+" ( " + $P{importoFideussione} + ") "]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="0" y="141" width="580" height="30" isRemoveLineWhenBlank="true" uuid="f2da75e0-d8d4-4ae0-b663-6b2bac6999a9">
		...
		<band height="76">			
			...
			<componentElement>
				...
				<jr:table xmlns:jr="http://jasperreports.sourceforge.net/jasperreports/components" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports/components http://jasperreports.sourceforge.net/xsd/components.xsd" whenNoDataType="AllSectionsNoDetail">
					<datasetRun subDataset="dettaglioSoggettoSD" uuid="2bf38382-8ac0-4f92-975a-7f5e90ec1e48">
						<dataSourceExpression><![CDATA[$P{dettaglioSoggetto}]]></dataSourceExpression>
					</datasetRun>					
					<jr:column width="120" uuid="5d6bf5be-cf92-4ae9-ae01-a215ebd1d7e4">
						...
						<jr:tableHeader style="Table 3_TH" height="30" rowSpan="1">
							...
							<staticText>
								...
								<text><![CDATA[Provincia erogazione]]></text>
							</staticText>
						</jr:tableHeader>
						<jr:detailCell style="Table 3_TD" height="30">
							<textField pattern="" isBlankWhenNull="true">
								...
								<textFieldExpression><![CDATA[$F{provinciaErogazione}]]></textFieldExpression>
							</textField>
						</jr:detailCell>
					</jr:column>
					<jr:column width="120" uuid="49746f88-33e7-40a7-9c8d-69a9e0fb6038">
						...
						<jr:detailCell style="Table 3_TD" height="30">
							<textField pattern="#,##0.00 €" isBlankWhenNull="true">
								...
								<textFieldExpression><![CDATA[$F{totaleVersato}]]></textFieldExpression>
							</textField>
						</jr:detailCell>
					</jr:column>
					<jr:column width="120" uuid="9ae99573-011d-45cc-82fa-0691ab4bb66e">
						...
						<jr:detailCell style="Table 3_TD" height="30">
							<textField pattern="#,##0.00 €" isBlankWhenNull="true">
								...
								<textFieldExpression><![CDATA[$F{totaleDichiarazione}]]></textFieldExpression>
							</textField>
						</jr:detailCell>
					</jr:column>
					<jr:column width="120" uuid="23f9cd33-5a38-4507-baa3-78de414adbc2">
						...
						<jr:detailCell style="Table 3_TD" height="30">
							<textField pattern="#,##0.00 €" isBlankWhenNull="true">
								...
								<textFieldExpression><![CDATA[$F{addizionaleLiquidata}]]></textFieldExpression>
							</textField>
						</jr:detailCell>
					</jr:column>
				</jr:table>
...
where id_report in (select id_report 
					from sigas_report 
					where cod_report like 'EXCEL_SOGGETTO')
...
import it.csi.sigas.sigasbl.doqui.acta.acaris.common.AllowedChildObjectTypeIdsType;
    ...
    extends ArchivePropertiesType
{
    ...
    /**
     * Recupera il valore della propriet� allowedChildObjectTypeIds.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della propriet� allowedChildObjectTypeIds.
     * 
     * @param value
     *     allowed object is
     *     {@link AllowedChildObjectTypeIdsType }

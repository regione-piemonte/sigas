...
public class UseCase  implements java.io.Serializable {
    private it.csi.sigas.sigasbl.integration.iride.Application appId;
    ...
    public UseCase(
           it.csi.sigas.sigasbl.integration.iride.Application appId,
           java.lang.String id) {
           this.appId = appId;
           this.id = id;
    }
     ...
     * @return appId
     */
    public it.csi.sigas.sigasbl.integration.iride.Application getAppId() {
        return appId;
    }
     ...
     * @param appId
     */
    public void setAppId(it.csi.sigas.sigasbl.integration.iride.Application appId) {
        this.appId = appId;
    }

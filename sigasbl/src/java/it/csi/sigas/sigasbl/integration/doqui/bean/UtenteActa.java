...
public class UtenteActa implements Serializable 
{
	...
	private String 		descrizioneVitalrecordcodetype;
	private Integer 	idStatoDiEfficacia;
	private String 	    descrizioneStatoDiEfficacia;
	...
	public String getDescrizioneVitalrecordcodetype() {
		return descrizioneVitalrecordcodetype;
	}

	public void setDescrizioneVitalrecordcodetype(String descrizioneVitalrecordcodetype) {
		this.descrizioneVitalrecordcodetype = descrizioneVitalrecordcodetype;
	}

	public String getDescrizioneStatoDiEfficacia() {
		return descrizioneStatoDiEfficacia;
	}

	public void setDescrizioneStatoDiEfficacia(String descrizioneStatoDiEfficacia) {
		this.descrizioneStatoDiEfficacia = descrizioneStatoDiEfficacia;
	}

...
public class ListaDiCarico  implements java.io.Serializable {
    private it.csi.sigas.sigasbl.integration.epay.to.PosizioneDaInserireType[] posizioniDaInserire;

    public ListaDiCarico() {
    }

    public ListaDiCarico(
           it.csi.sigas.sigasbl.integration.epay.to.PosizioneDaInserireType[] posizioniDaInserire) {
     ...
     */
    public it.csi.sigas.sigasbl.integration.epay.to.PosizioneDaInserireType[] getPosizioniDaInserire() {
        return posizioniDaInserire;
    }
     ...
     */
    public void setPosizioniDaInserire(it.csi.sigas.sigasbl.integration.epay.to.PosizioneDaInserireType[] posizioniDaInserire) {
        this.posizioniDaInserire = posizioniDaInserire;
    }

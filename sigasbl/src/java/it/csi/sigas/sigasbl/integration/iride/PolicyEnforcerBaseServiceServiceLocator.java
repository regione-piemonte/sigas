...
public class PolicyEnforcerBaseServiceServiceLocator extends org.apache.axis.client.Service implements it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseServiceService {
    ...
    public it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseService getPolicyEnforcerBase() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseService getPolicyEnforcerBase(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseSoapBindingStub(portAddress, this);
            _stub.setPortName(getPolicyEnforcerBaseWSDDServiceName());
            return (PolicyEnforcerBaseService) _stub;
        }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.sigas.sigasbl.integration.iride.PolicyEnforcerBaseSoapBindingStub(new java.net.URL(PolicyEnforcerBase_address), this);
                _stub.setPortName(getPolicyEnforcerBaseWSDDServiceName());
                return (Remote) _stub;
            }
        }
